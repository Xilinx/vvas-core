...
/* BO Related APIs */
      ...
      vvas_bo_flags flags, uint32_t mem_bank)
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS XRT BO allocation failed");
      return NULL;
    };
      ...
      vvas_xrt_create_sub_bo (vvasBOHandle parent, size_t size, size_t offset)
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS XRT SUB BO allocation failed");
      return NULL;
    };
  ...
  int vvas_xrt_unmap_bo (vvasBOHandle bo, void *addr)
  {
    ...
    DEBUG_PRINT
        ("Currently unmap is a dummy function, free will do unmap as well");
    return 0;
  }
      ...
      bool write /* Not used as of now, as its always read and write */ )
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS map BO failed");
      return NULL;
    };
    return data;
  }
      ...
      const void *src, size_t size, size_t seek)
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS XRT write failed");
      return -1;
    };
      ...
      vvas_bo_sync_direction dir, size_t size, size_t offset)
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS XRT sync BO failed");
      return -1;
    };
      ...
      size_t skip)
  {
    ...
    try {
      ...
      ERROR_PRINT ("VVAS XRT read BO failed");
      return -1;
    };
    return 0;
  }
...
/* Device APIs */
      ...
      vvasDeviceHandle handle, uuid_t * xclbinId)
  {
    ...
    if (access (bit, F_OK) == 0) {
      ...
      try {
        ...
        ERROR_PRINT ("xclbin load failed");
        delete xclbin;
        return -1;
      };
...
#ifdef XLNX_U30_PLATFORM
  void vvas_free_ert_xcl_xrt_buffer (xclDeviceHandle handle,
      xrt_buffer * buffer)
  {
  ...
  int32_t vvas_softkernel_xrt_open_device (int32_t dev_idx,
      xclDeviceHandle xcl_dev_hdl, vvasDeviceHandle * dev_handle)
  {
    xrt::device * device = new xrt::device {
    xcl_dev_hdl};
    *dev_handle = device;
...
/* TODO: vvas_xrt_send_softkernel_command() will be updated in 2022.1 XRT */
      ...
      unsigned int *payload, unsigned int num_idx, int timeout)
  {
    ...
    if (ret < 0) {
      ERROR_PRINT
          ("[bo %p] XRT run handle failed with ret = %d. reason : %s",
