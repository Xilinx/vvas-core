...
vvas_tfssd::vvas_tfssd (void * handle, const std::string & model_name,
...
bool
compare_by_area (const vitis::ai::TFSSDResult::BoundingBox & box1,
    const vitis::ai::TFSSDResult::BoundingBox & box2)
{
...
int
vvas_tfssd::run (void * handle, std::vector < cv::Mat > &images,
...
int
vvas_tfssd::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_tfssd::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_tfssd::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_tfssd::~vvas_tfssd ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
