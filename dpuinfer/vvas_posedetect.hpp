...
class vvas_posedetect:public vvas_dpumodel
{

  int log_level = 0;
  std::unique_ptr < vitis::ai::PoseDetect > model;

public:

  vvas_posedetect (void * handle, const std::string & model_name,
