...
class vvas_efficientdetd2:public vvas_dpumodel
{

  int log_level = 0;
  std::unique_ptr < vitis::ai::EfficientDetD2 > model;

public:

  vvas_efficientdetd2 (void * handle, const std::string & model_name,
