...
class vvas_facelandmark:public vvas_dpumodel
{

  int log_level = 0;
  std::unique_ptr < vitis::ai::FaceLandmark > model;

public:

  vvas_facelandmark (void * handle, const std::string & model_name,
