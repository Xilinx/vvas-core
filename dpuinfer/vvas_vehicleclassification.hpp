...
class vvas_vehicleclassification:public vvas_dpumodel
{
  int log_level = 0;
  std::unique_ptr < vitis::ai::VehicleClassification > model;

public:
  vvas_vehicleclassification (void *handle, const std::string & model_name,
  ...
  virtual ~vvas_vehicleclassification ();
};
