...
vvas_refinedet::vvas_refinedet (void * handle,
...
bool
compare_by_area (const vitis::ai::RefineDetResult::BoundingBox & box1,
    const vitis::ai::RefineDetResult::BoundingBox & box2)
{
...
int
vvas_refinedet::run (void * handle, std::vector < cv::Mat > &images,
...
int
vvas_refinedet::requiredwidth (void)
{
...
int
vvas_refinedet::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_refinedet::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_refinedet::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_refinedet::~vvas_refinedet ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
