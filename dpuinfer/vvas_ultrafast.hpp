...
class vvas_ultrafast:public vvas_dpumodel
{

  int log_level = 0;
  std::unique_ptr < vitis::ai::UltraFast > model;

public:

  vvas_ultrafast (void * handle, const std::string & model_name,
