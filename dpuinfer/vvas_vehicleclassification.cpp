...
vvas_vehicleclassification::vvas_vehicleclassification (void * handle,
    const std::string & model_name, bool need_preprocess)
{
  ...
  model = vitis::ai::VehicleClassification::create (model_name, need_preprocess);
}

int
vvas_vehicleclassification::run (void * handle, std::vector<cv::Mat>& images,
...
int
vvas_vehicleclassification::requiredwidth (void)
{
...
int
vvas_vehicleclassification::requiredheight (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_vehicleclassification::supportedbatchsz (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
...
int
vvas_vehicleclassification::close (void)
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
  return true;
}

vvas_vehicleclassification::~vvas_vehicleclassification ()
{
  LOG_MESSAGE (LOG_LEVEL_DEBUG, log_level, "enter");
}
